export const verifyEmailTemplate = (
  ...
  subject: "Confirm your Alpha Software account",
  ...
  html: `
    <html><head><style>
      ...
      <div class="container">
        <div class="header">Verify your Alpha Software account</div>
        <div class="content">
          ...
          <p>Please note that this verification link will expire in 45 minutes.</p>
...
export const passwordResetTemplate = (
  ...
  html: `
    <html><head><style>
      ...
      <div class="container">
        <div class="header">Alpha software</div>
        <div class="content">
